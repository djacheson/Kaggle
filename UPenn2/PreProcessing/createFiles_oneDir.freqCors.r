#CORRELATIONS FOR DIFFERENT FREQUENCY BANDS

#This function was added to expand the feature space to include correlations across different frequency bands

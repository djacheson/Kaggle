#CORRELATIONS AND MUTUAL INFORMATION OF SIGNAL ACROSS CHANNELS

#This function was added to expand the feature space to include correlation and mutual information features
...
createFiles_oneDir <- function(dirs) {
    ...
    makeFeatures <- function(filename) {
        #Create correlation and mutual information (MI) features

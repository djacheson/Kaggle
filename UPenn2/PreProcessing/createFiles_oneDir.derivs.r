#FEATURES OF FIRST DERIVATIVE OF THE DATA

#This function was added to expand the feature space to include derivative features
...
#NOTE: This massively expands the feature space
...
createFiles_oneDir <- function(dirs) {
    ...
    makeFeatures <- function(filename) {
      #here, calculate the derivative features
        ...
        derivs <- getDerivs_all_freq(file)
